fluidRow(column(12 ,
  br(),
  p(icon("info-circle"), "Do not forget to click on the 'display' buttons to get data.", style = "color:#367FA9"),
  p(icon("hourglass-end"), "When selecting a mRNA / protein, generating single-cell graĥs will involve computing time and might take a while, please be patient.", style = "color:#fa6e0a"),
  p(icon("exclamation-triangle"), "If you feel that the app is stuck, reload the page.", style = "color:#CB4A4A"),
  br(),
  fluidRow(column(2, div(h5(tags$b("Select your gene")),
                         ...
                         br(),
                         fluidRow(column(12, verbatimTextOutput("iD.exist"))),
                        br())),
